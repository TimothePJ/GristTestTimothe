export function getDomRefs() {
  ...
  return {
    ...
    planningAlertsList: document.getElementById("planning-alerts-list"),
    planningAlertsCloseBtn: document.getElementById("planning-alerts-close-btn"),
    ...
    editSegmentMonthLabel: document.getElementById("edit-segment-month-label"),
    editSegmentWorkerLabel: document.getElementById("edit-segment-worker-label"),
    ...
    editSegmentLoad: document.getElementById("edit-segment-load"),
    editSegmentLoadTrack: document.getElementById("edit-segment-load-track"),
...
export function assertDomRefs(domRefs) {
  const requiredKeys = [
    ...
    "saveEditedBudgetBtn",
    "cancelEditBudgetBtn",
    "editSegmentMonthLabel",
    "editSegmentWorkerLabel",
    "editSegmentEffectifInput",
    "editSegmentCalculatedDays",
    "editSegmentLoad",
    "editSegmentLoadTrack",
    "editSegmentLoadFill",
    "editSegmentLoadDays",
