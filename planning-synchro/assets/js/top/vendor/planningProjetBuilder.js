// VENDORED from `Planning Projet/assets/js/services/planningService.js` — the
// exact read-only timeline builder. Only the 3 imports below are re-shimmed so
// planning-synchro stays self-contained (local toText + config shim + vendored
// realisation util). Don't edit the logic: to update, re-copy the source and
// re-apply these three import lines.
